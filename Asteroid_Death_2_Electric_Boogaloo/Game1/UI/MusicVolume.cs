...
namespace Game1.UI
{
    public class MusicVolume:BaseUiComponent
    {
        ...
        public MusicVolume(AsteroidsGame game, Vector2 position, bool canBeHighlighted, EventHandler clickEvent, SpriteFont font) : base(game, position, canBeHighlighted, clickEvent, font)
        {
        ...
        public override void Update()
        {
            ...
            switch (_highlight)
            {
                case 0:
                    _EffectVoume = "0%";
                    Globals._universalMusicVolume = 0;
                    break;

                case 1:
                    _EffectVoume = "5%";
                    Globals._universalMusicVolume = 0.05f;
                    break;

                case 2:
                    _EffectVoume = "10%";
                    Globals._universalMusicVolume = 0.1f;
                    break;

                case 4:
                    _EffectVoume = "15%";
                    Globals._universalMusicVolume = 0.15f;
                    break;
                case 5:
                    _EffectVoume = "20%";
                    Globals._universalMusicVolume = 0.2f;
                    break;
                case 6:
                    _EffectVoume = "25%";
                    Globals._universalMusicVolume = 0.25f;
                    break;
                case 7:
                    _EffectVoume = "30%";
                    Globals._universalMusicVolume = 0.3f;
                    break;
                case 8:
                    _EffectVoume = "35%";
                    Globals._universalMusicVolume = 0.35f;
                    break;
                case 9:
                    _EffectVoume = "40%";
                    Globals._universalMusicVolume = 0.4f;
                    break;
                case 10:
                    _EffectVoume = "45%";
                    Globals._universalMusicVolume = 0.45f;
                    break;
                case 11:
                    _EffectVoume = "50%";
                    Globals._universalMusicVolume = 0.5f;
                    break;
                case 12:
                    _EffectVoume = "55%";
                    Globals._universalMusicVolume = 0.55f;
                    break;
                case 13:
                    _EffectVoume = "60%";
                    Globals._universalMusicVolume = 0.6f;
                    break;
                case 14:
                    _EffectVoume = "65%";
                    Globals._universalMusicVolume = 0.55f;
                ...
                case 15:
                    _EffectVoume = "70%";
                    Globals._universalMusicVolume = 0.7f;
                    break;
                case 16:
                    _EffectVoume = "75%";
                    Globals._universalMusicVolume = 0.75f;
                    break;
                case 17:
                    _EffectVoume = "80%";
                    Globals._universalMusicVolume = 0.8f;
                    break;
                case 18:
                    _EffectVoume = "85%";
                    Globals._universalMusicVolume = 0.85f;
                    break;
                case 19:
                    _EffectVoume = "90%";
                    Globals._universalMusicVolume = 0.9f;
                    break;
                case 20:
                    _EffectVoume = "95%";
                    Globals._universalMusicVolume = 0.95f;
                    break;
                case 21:
                    _EffectVoume = "100%";
                    Globals._universalMusicVolume = 1f;
                    break;
            }
        }
